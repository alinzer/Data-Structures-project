...
public class Test {
    public static void main(String[] args) throws URISyntaxException {
        ...
        try {
            ...
            hash.putDocument(is4,tst4, DocumentFormat.TXT);
            hash.putDocument(is5,tst5, DocumentFormat.TXT);
            ...
            hash.putDocument(is16,j, DocumentFormat.TXT);
            hash.putDocument(is17, tst16, DocumentFormat.BINARY);
        ...
        // System.out.println(hash.getDocument(j));
    }
