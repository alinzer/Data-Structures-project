...
public class DocumentStoreAPITest {
    ...
    @Test
    public void setMaxDocumentCountExists() throws URISyntaxException {
        try {
            new DocumentStoreImpl().setMaxDocumentCount(5);
        } catch (Exception e) {}
    }
    
    @Test
    public void setMaxDocumentBytesExists() throws URISyntaxException {
        try {
            new DocumentStoreImpl().setMaxDocumentCount(5);
        } catch (Exception e) {}
    }
